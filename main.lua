...
-- [[ MAIN: SPEEDWALK & AUTO SKILL CHECK ]] --
MainTab:Slider({
    Title = "Speedwalk",
...
VisualTab:Toggle({ Title = "ESP Team (Red/White)", Callback = function(s) espActive = s end })
...
Window:Notify({ Title = "Terehub V10", Content = "Speedwalk & Auto Skill Check Siap!", Duration = 5 })